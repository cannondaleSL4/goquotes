...
var QuotesMap = map[string]string{
	...
	//"AAPL":  "Apple Inc.",
	//"T":     "AT&T Inc.", // not in DJ
	//"BA":    "Boeing Company",
	//"CAT":   "Caterpillar Inc.",
	//"CVX":   "Chevron Corp.",
	//"CSCO":  "Cisco Systems",
	//"C":     "Citigroup Inc.", // not in DJ
	...
	//"PG":    "Procter & Gamble",
	//"PFE":   "Pfizer Inc.",
	//"ORCL":  "Oracle Corp.", // not in DJ
	//"BAC":   "Bank of America Corp", // not in DJ
	//"WFC":   "Wells Fargo", // not in DJ
	//"PNC":   "PNC Financial Services", // not in DJ
	//"BK":    "The Bank of New York Mellon Corp.", // not in DJ
	"NKE":   "Nike",
